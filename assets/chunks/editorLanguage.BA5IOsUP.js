import{d as g,c,o as a,G as n,w as s,C as l,p as u,F as m,B as x,b as V}from"./framework.DqtzHBVO.js";const h=g({__name:"editorLanguage",setup(b){const t=u("javascript"),d=u(["javascript","json","html","vue","css","less","sass","markdown","python","java","sql","xml","yaml"]),r=u(`const count = 0;
